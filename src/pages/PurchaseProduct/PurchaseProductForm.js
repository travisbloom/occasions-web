...
class PurchaseProductForm extends React.Component {
  ...
  onAddNewAddress = ({data}) => {
    ...
    const newAssociatedLocation =
      data.createAssociatedLocation.associatedLocation;
    return refetch()
      .then(() =>
        change('locationId', {
  ...
  getLocationOptions = () => {
    const locations = this.props.associatedEvent.receivingPerson
      .associatedLocations.edges;
